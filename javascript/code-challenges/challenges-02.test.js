...
const raisedToTheThird = (arr) => {
  ...
  // ieterate over each number in the input array. 
  arr.forEach(num => {
    // Use Math.pow() to raise the current num to the power of 3
    // push resut into the result array. 
...
const addQuestion = (arr) => {
  ...
  // iterate over arr. 
  arr.forEach(num => {
    // add a question mark after each string.
